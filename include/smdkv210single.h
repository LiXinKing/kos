...
//#define CONFIG_BOOTARGS    	"console=ttySAC0,115200 noinitrd root=/dev/mtdblock3 init=/init radio=wcdma" 
#define CONFIG_BOOTARGS    	"console=ttySAC0,115200 root=/dev/mtdblock4 init=/linuxrc"
#define CONFIG_ETHADDR		00:22:12:34:56:90
#define CONFIG_NETMASK          255.255.255.0
#define CONFIG_IPADDR		192.168.1.20
#define CONFIG_SERVERIP		192.168.1.129
...
#define CFG_PROMPT              "GZSD210 # "   /* Monitor Command Prompt       */
...
#define DMC1_MEMCONFIG_0	0x30F01323	// MemConfig0	256MB config, 8 banks,Mapping Method[12:15]0:linear, 1:linterleaved, 2:Mixed
...
#define PHYS_FLASH_SIZE		0//0x800000	/* 8MB */
...
#define CONFIG_IDENT_STRING	" for GZSD210"
...
#endif
#define STACK_COPY			MEMORY_BASE_ADDRESS+0x10000000
#define sd_copy_base		MEMORY_BASE_ADDRESS -16
