...
#define		INTP			__REG(RTC_BASE + 0x30)
#define		RTCCON			__REG(RTC_BASE + 0x40)
#define		TICCNT			__REG(RTC_BASE + 0x44)
#define		RTCALM			__REG(RTC_BASE + 0x50)
#define		ALMSEC			__REG(RTC_BASE + 0x54)
#define		ALMMIN			__REG(RTC_BASE + 0x58)
#define		ALMHOUR			__REG(RTC_BASE + 0x5c)
#define		ALMDATE			__REG(RTC_BASE + 0x60)
#define		ALMMON			__REG(RTC_BASE + 0x64)
#define		ALMYEAR			__REG(RTC_BASE + 0x68)
#define		RTCRST			__REG(RTC_BASE + 0x6c)
#define		BCDSEC			__REG(RTC_BASE + 0x70)
#define		BCDMIN			__REG(RTC_BASE + 0x74)
#define		BCDHOUR			__REG(RTC_BASE + 0x78)
#define		BCDDATE			__REG(RTC_BASE + 0x7c)
#define		BCDDAY			__REG(RTC_BASE + 0x80)
#define		BCDMON			__REG(RTC_BASE + 0x84)
#define		BCDYEAR			__REG(RTC_BASE + 0x88)
#define		CURTICCNT		__REG(RTC_BASE + 0x90)
#define		RTCLVD			__REG(RTC_BASE + 0x94)
...
#define GPBCON_REG			__REG(GPBCON)
#define GPBDAT_REG			__REG(GPBDAT)
